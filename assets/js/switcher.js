    ...
    addSwitcher(),
      ...
      jQuery(".skin-1").on("click", function () {
        return (
          ...
          jQuery(".header-transparent .logo-header img").attr(
            "src",
            "assets/images/logo-white.png"
          ),
          jQuery(".logo-header.logo-white img").attr(
            "src",
            "assets/images/logo-white.png"
          ),
          jQuery(".box-header .logo-header img").attr(
            "src",
      ...
      jQuery(".skin-5").on("click", function () {
        return (
          ...
          jQuery(".header-transparent .logo-header img").attr(
            "src",
            "assets/images/logo-white-5.png"
          ),
          jQuery(".logo-header.logo-white img").attr(
            "src",
            "assets/images/logo-white-5.png"
      ...
      jQuery(".skin-6").on("click", function () {
        return (
          ...
          jQuery(".header-transparent .logo-header img").attr(
            "src",
            "assets/images/logo-white-6.png"
          ),
          jQuery(".logo-header.logo-white img").attr(
            "src",
            "assets/images/logo-white-6.png"
      ...
      jQuery(".skin-7").on("click", function () {
        return (
          ...
          jQuery(".header-transparent .logo-header img").attr(
            "src",
            "assets/images/logo-white-7.png"
          ),
          jQuery(".logo-header.logo-white img").attr(
            "src",
            "assets/images/logo-white-7.png"
      ...
      jQuery(".skin-8").on("click", function () {
        return (
          ...
          jQuery(".header-transparent .logo-header img").attr(
            "src",
            "assets/images/logo-white-8.png"
          ),
          jQuery(".logo-header.logo-white img").attr(
            "src",
            "assets/images/logo-white-8.png"
      ...
      jQuery(".menubar-top").on("click", function () {
        ...
        jQuery(".content-scroll").removeClass(
          ...
          jQuery(".header-nav").append(e).append(a).append(i);
      }),
...
function setThemePanel() {
  jQuery.each(themeOption, function (e, a) {
    if (
      ...
      if ("themeStandardColor" == a)
        jQuery(".skin").attr("href", themeOptionItemValue + ".css"),
          setThemeLogo(a);
      else if ("themeFullColor" == a)
        jQuery(".skin").attr("href", themeOptionItemValue + ".css"),
          setThemeLogo(a);
      else if ("layout" == a)
        ...
        if (
          ...
          jQuery(".content-scroll").removeClass(
            ...
            jQuery(".header-nav").empty(),
            jQuery(".header-nav").append(i).append(r).append(s);
        }
      } else
        "bgColor" == a
...
function setThemeLogo(e) {
  ...
  "" != a &&
    (jQuery(".logo-white img").attr("src", a),
    jQuery(".logo-dark img").attr("src", a),
    jQuery(".logo-center .logo-c").attr("src", a));
}
...
function getCookie(e) {
  for (
    var a = e + "=", i = decodeURIComponent(document.cookie).split(";"), r = 0;
    r < i.length;
    r++
  ) {
  ...
  jQuery(document).ready(function () {
    jQuery(".theme-panel-save li a, .theme-panel-save li img").on(
      ...
      function () {
        ...
        else if ("themeStandardColor" == a)
          deleteCookie("themeFullColor_value");
        else if ("themeFullColor" == a) {
          setCookie("logo_value", jQuery(this).attr("logo"), 1),
            deleteCookie("themeStandardColor_value");
        } else if ("themeStandardColor" == a || "themeFullColor" == a) {
          setCookie(a + "_logo", jQuery(this).attr("logo"), 1);
        }
